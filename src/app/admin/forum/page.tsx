                ...
                render: (row) => (
                  <div className="flex gap-2">
                    <button
                      ...
                      className="inline-flex items-center px-3 py-1.5 rounded-lg text-xs font-semibold border border-border bg-white hover:bg-muted transition-colors disabled:opacity-50"
                    >
